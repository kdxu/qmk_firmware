...
[_QWERTY] = LAYOUT( \
  ...
  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,         KC_H,    KC_J,    KC_K,    KC_L,    KC_LALT, \
  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_LGUI, \
                    KC_LCTL, LOWER, TD(TD_SAKN),         KC_BSPC, RAISE, OSM(MOD_LSFT)            \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_LCTL, KC_GRV,  _______, KC_LALT, KC_LGUI,      _______, _______, _______, KC_BSLS,  KC_QUOT, \
                    _______, LOWER, _______,     _______, _______, KC_LSFT                   \
),
...
[_LOWER] = LAYOUT( \
  ...
  TD(TD_ALF), _______, _______, _______, _______,   KC_MINS, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, \
  KC_TILD, _______, _______, _______, _______,      _______, TD(CT_CLN), KC_SLSH, KC_PIPE,  KC_DQT, \
