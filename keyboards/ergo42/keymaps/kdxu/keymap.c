...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |      |      |      |  Alt |  Gui |LOWER |Space |   | Bksp | RAISE|   -  |   =  | LEFT | DOWN | RIGHT|
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
    ...
    XXXXXXX,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_UP,  XXXXXXX, \
    XXXXXXX,  XXXXXXX, XXXXXXX, KC_LALT, KC_LGUI, LOWER,   KC_SPC, KC_BSPC,  RAISE,   KC_MINS, KC_EQL, KC_LEFT, KC_DOWN, KC_RGHT \
  ),
